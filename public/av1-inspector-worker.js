...
// Block/transform size, prediction mode, skip, reference frames, motion vectors,
// and the current per-block quantizer index.
const INSPECTION_LAYERS = (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5) | (1 << 8) | (1 << 9) | (1 << 13);
